...
# WARNING: Ensure imports from `health_notification_manager` comes after this line
from health_notification_manager import app, settings, db  # noqa
from health_notification_manager.cli import create_user, cli  # noqa
