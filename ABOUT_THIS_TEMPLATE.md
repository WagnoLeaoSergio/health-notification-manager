...
├── health_notification_manager             # The main python package for the project
...
e.g: `cat health_notification_manager/VERSION` will get the project version without harming
